...
class MainPage(BasePage):
    @allure.step('Клик по кнопке перехода в личный кабинет в хэдере')
    ...
    @allure.step('Получить номер из окна о создании заказа')
    ...
    @allure.step('Клик на кнопку закрытия окна о создании заказа')
