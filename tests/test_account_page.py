...
class TestAccountPage:
    @allure.title('Проверка перехода в профиль по клику на кнопку "Личный кабинет" в шапке')
    ...
    @allure.title('Проверка перехода в историю по клику на кнопку «Лента заказов»')
    ...
    @allure.title('Проверка выполнения логаута при клике по кнопке "Выйти"')
