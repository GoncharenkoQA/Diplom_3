...
class MainPageLocators:
    ...
    # Селектор, который выделяет активный раздел
    ...
    # Заголовок "Булки" в меню конструктора
    buns_block = (By.XPATH, '//span[text() = "Булки"]')

    # Заголовок "Соусы" в меню конструктора
    sauces_block = (By.XPATH, '//span[text() = "Соусы"]')

    # Заголовок "Начинки" в меню конструктора
    ...
    # Кнопка с Х, закрывающая окно "Детали ингредиента"
    ...
    # Место для перетягивания ингредиентов в правой части
    ...
    # Кнопка с Х, закрывающая окно подтверждения заказа
